...
class TestDropblockPlatforms(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.conflict_file = Path(self.temp_dir) / "test_file (user's conflicted copy 2024-01-01).txt"
    ...
    def test_macos_ignore(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            mock_run.reset_mock()
            file_provider_path = Path("/Users/test/Library/CloudStorage/Dropbox/test.txt")
